...
export default function RegisterForm() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen text-white">
      <div className="card glass p-6 rounded-lg shadow-lg md:w-1/3 w-full">
        <h1 className="text-white font-bold text-5xl text-center">Бүртгүүлэх</h1>

        <form onSubmit={handleSubmit} className="mt-5">
          <label
            htmlFor="Name"
            className="block mt-5 mb-2 text-sm font-medium text-white"
          >
            Нэр
          </label>
          <input
