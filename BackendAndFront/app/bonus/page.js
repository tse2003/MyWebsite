...
export default function Page() {
    return (
        <div className="m-auto w-full h-full px-4">
            ...
            <div className="text-white w-full sm:w-[1200px] mx-auto px-4">
                <h1 className="text-2xl sm:text-3xl font-bold pt-10">Өргөө кинотеатрын гишүүнчлэл бонус картны давуу тал:</h1>
                ...
                <h1 className="text-2xl sm:text-3xl font-bold pt-10">Бонус картны хүчин төгөлдөр үйлчлэх салбар ба байршилууд:</h1>
                <h1 className="text-lg sm:text-xl font-bold pl-5">Бонус картны хүчин төгөлдөр үйлчлэх салбар ба байршилууд:</h1>
                ...
                <p className="text-lg sm:text-xl font-bold pt-10 pl-5">Өргөө кинотеатрын дараах хэсгүүдэд хүчин төгөлдөр үйлчилж бонус төгрөг цуглуулах боломтой. Үүнд:</p>
                <ul className="list-disc list-inside pl-10">
                    <li>Мобайл апп</li>
                ...
                <h1 className="text-2xl sm:text-3xl font-bold pt-10">Хэрхэн бонус картын хэрэглэгч болох талаар:</h1>
                <p className="text-lg sm:text-xl pl-5">Бонус картын бүртгэлийг Өргөө 2 салбарт мэдээллийн ажилтан, Өргөө 1 салбарт 2 давхарт байрлах Лоунж хэсэгт хэрэглэгчийн төрсний гэрчилгээ болон иргэний үнэмлэхийг үндэслэн бүртгэнэ. Бүртгэхдээ дараах мэдээллийг хэрэглэгчээс авна</p>
                <ul className="list-disc list-inside pl-10">
                    <li>Овог нэр, хүйс, төрсөн он сар өдөр, регистерийн дугаар, утасны дугаар, имэйл хаяг, пин код</li>
                </ul>
                <h1 className="text-2xl sm:text-3xl font-bold pt-10">Бонус төгрөг шилжүүлэх:</h1>
                <ul className="list-disc list-inside pl-5">
