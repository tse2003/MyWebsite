  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-semibold text-gray-800">Засах</h1>
      </div>
      <form onSubmit={handleSubmit} className="space-y-6 bg-white p-8 rounded-lg shadow-md">
        ...
        {/* Duration */}
        <div className="space-y-2">
          <label htmlFor="newDuration" className="text-sm font-semibold text-gray-700">Үргэлжлэх хугацаа</label>
          <input
            id="newDuration"
        ...
        <button
          type="submit"
          className="btn btn-primary w-full mt-4 hover:bg-blue-700 transition-colors"
        >
          Update Movie
        </button>
      </form>
