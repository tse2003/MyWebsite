    ...
    <div>
      <div className="m-auto w-[100%] h-[660px] flex">
        ...
        <div className='w-[50%] h-[660px] p-[8%]'>
          ...
          <label for="Email" className="block mt-5 mb-2 text-sm font-medium text-white">Нэр</label>
          <input type="text" id="Email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Нэр" required />
          ...
          <input type="text" id="Password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Та шинэ нууц үг оруулна уу" required />
          <button class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-full w-full mt-5">Бүртгүүлэх</button>
